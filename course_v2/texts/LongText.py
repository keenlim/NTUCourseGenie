...
The chatbot will be made available and accessible by NTU students. Upon registration, your NTU email address and your name will be recorded in the database. Your conversation and interaction with the chatbot, i.e. chatlog, will be recorded in the database as well.

**3) Data Use and Confidentiality**    
Your identity and personal information will be kept confidential and stored securely. The chatlog stored in the database will be used as part of the chatbot features improvement, analytics (for example, sentiment analysis), and for this research purposes only. The aggregated results and finding from the analysis may be published or presented for academic and scientific purposes only, but your personal information will never be disclosed. Possible outlets of dissemination may be within the project team members and potentially carried forward for future project as background study.
...
Your participation in this study is completely voluntary, and you have the right to withdraw from the study at any time without any penalty. Your access to the chatbot will be revoked or suspended if you are found (or attempt to) abusing or tempering the chatbot which may causes harm to the chatbot or other users. You may stop using the chatbot if you feel uncomfortable or have lost interest interacting with the chatbot. 
